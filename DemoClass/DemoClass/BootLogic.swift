...
class BootLogic: NSObject {
    ...
    class func boot(window:UIWindow){
        ...
        var CodeCamp1 =  [SECTION: "CodeCamp1", MENU:[
            [TITLE: "Bai1",CLASS:"Bai1"],[TITLE: "Bai3",CLASS:"Bai3"],[TITLE: "Bai4",CLASS:"Bai4"],[TITLE: "Bai6",CLASS:"Bai6"]
            ]
        ]

        mainScreen.menu = [basic, function, collection, advanced,CodeCamp1]
